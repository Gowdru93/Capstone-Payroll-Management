...
const EmployeeList = () => {
  ...
  return (
    <div className="page-transition bg-light p-3 rounded">
      {/* Header */}
      <div className="d-flex justify-content-between align-items-center mb-4">
        <h1 className="h3 mb-0 text-dark">Employee Management</h1>
              ...
              <table className="table table-hover mb-0">
                <thead className="table-light">
                  <tr>
                    ...
                    <th onClick={() => handleSort('departmentName')} className="cursor-pointer">
                    ...
                    <th onClick={() => handleSort('hireDate')} className="cursor-pointer">
                      Hire Date <i className={`bi ${getSortIcon('hireDate')} ms-1`}></i>
                    </th>
                    <th onClick={() => handleSort('leaveBalance')} className="cursor-pointer">
